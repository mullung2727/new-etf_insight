...
# DRY RUN until the dry-run comparison in research/private/high52_quiet_breakout/PLAN_LIVE.md passes.
# Change "--dry-run" to "false" only with explicit user approval.
#
...
& ".venv\Scripts\python.exe" -m research.private.high52_quiet_breakout.live.order `
  "--dry-run" "true" "--broker-url" "http://localhost:8002" `
